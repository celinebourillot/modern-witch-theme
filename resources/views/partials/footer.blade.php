<?php 
  ...
  $content = get_field('footer columns','option');
  $socialMedia = get_field('show_social_media_icons','option');
...
?>
    ...
    <footer class="footer">
            <div class="container">
                ...
                @if($tagline)
                  <h3 class="align-center">{{ $tagline }}</h3>
                @endif
                ...
                <div class="columns">
                  ...
                  @if($socialMedia == true)
                    ...
                    @if($content)
                        ...
                        @while (have_rows('footer columns','option'))@php(the_row())
                                ...
                                @if ($links)
                                  ...
                                  <ul>
                                        ...
                                        @while (have_rows('Links'))@php(the_row())
                                            <li><a href="{!! get_sub_field('page_url') !!}">{!! get_sub_field('label') !!}</a></li>
                                        @endwhile
